...
\fancyhf{} % on efface tout et on recommence
	% PIED DE PAGE :
	\fancyfoot[LO,RE]{3IF - Binôme 3213 \hfill{} \textbf{Manuel d'utilisation - TP-AC - Classe Simple} \hfill{} \thepage }
...
\fbox{
    ...
    \begin{center}
		\vspace*{0.21cm}\Huge \color{blue} \textbf{\bsc{Manuel d'utilisation} }
	\end{center}
	\end{minipage}
}
